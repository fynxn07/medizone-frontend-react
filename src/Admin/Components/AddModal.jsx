        ...
        >
          ×
                ...
                <div className="flex flex-col gap-4">
                    <label className="text-sm font-semibold text-gray-700">
                        ...
                        <input
                            ...
                            className="border border-gray-300 p-3 rounded-xl w-full mt-1 focus:ring focus:ring-blue-200 focus:outline-none shadow-sm"
                        />
                    </label>
                    ...
                    <label className="text-sm font-semibold text-gray-700">
                        ...
                        <textarea
                            ...
                            onChange={handleChange}
                            rows={3}
                            className="border border-gray-300 p-3 rounded-xl w-full mt-1 resize-none focus:ring focus:ring-blue-200 focus:outline-none shadow-sm"
                        />
                    </label>
                ...
                <div className="flex justify-end gap-4 mt-6">
                    ...
                    <button
                        onClick={Save}
                        className="bg-blue-600 text-white px-6 py-2 rounded-xl hover:bg-blue-700 shadow-lg transition"
                    >
                        Save
                    </button>
                </div>
