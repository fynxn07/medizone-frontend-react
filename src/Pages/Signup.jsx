...
//                 axios.post("http://127.0.0.1:8000/medicals/auth/register/", {
//                     ...form,
...
function Signup() {
    ...
    async function setData(e) {
        ...
        try {
            ...
            const res = await axios.post("http://127.0.0.1:8000/medicals/auth/register/", {
                username: form.name,       // 👈 map name -> username
                email: form.email,
